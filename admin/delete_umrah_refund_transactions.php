...
try {
    ...
    ");
    $getTransactionStmt->execute([$transaction_id, $refund_id, 'umrah_refund', $tenant_id]);
    ...
    $deleteStmt = $pdo->prepare("
        ...
        AND tenant_id = ?
    ");
    $deleteResult = $deleteStmt->execute([$transaction_id, $refund_id, 'umrah_refund', $tenant_id]);

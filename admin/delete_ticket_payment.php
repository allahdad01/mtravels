...
try {
    ...
    $getTransactionStmt = $pdo->prepare("
        ...
        WHERE t.id = ? AND t.transaction_of = ? AND t.tenant_id = ?
    ");
    $getTransactionStmt->execute([$transaction_id, 'ticket_sale', $tenant_id]);
    ...
    $deleteStmt = $pdo->prepare("
        ...
        AND tenant_id = ?
    ");
    $deleteResult = $deleteStmt->execute([$transaction_id, $ticket_id, 'ticket_sale', $tenant_id]);

...
if (isset($_GET['ticket_id'])) {
    ...
    try {
        // Prepare a query to fetch all transactions for the given refund ticket ID
        $stmt = $pdo->prepare("
            SELECT t.id, t.tenant_id, t.main_account_id, t.type, t.amount, t.currency, t.description,
                   t.transaction_of, t.reference_id, t.balance, t.created_at, t.receipt, t.exchange_rate
        ...
        error_log("Error fetching ticket transactions: " . $e->getMessage());

...
<style>
        ...
        @media (max-width: 576px) {
            ...
            /* Make Add Client-Supplier Payment Modal responsive */
            #addClientSupplierModal .modal-dialog {
                max-width: 95%;
                margin: 0.5rem auto;
            }
            ...
            #addClientSupplierModal .form-group {
                margin-bottom: 1rem;
            }

            #addClientSupplierModal .form-control {
                font-size: 16px; /* Prevent zoom on iOS */
            }

            #addClientSupplierModal .btn {
                width: 100%;
                margin: 0.25rem 0;
            }

            /* Stack modal footer buttons vertically on mobile */
            #addClientSupplierModal .modal-footer {
                flex-direction: column;
            }

            #addClientSupplierModal .modal-footer .btn {
                width: 100%;
            }

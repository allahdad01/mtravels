...
$query = "
    ...
    WHERE mat.id = ? AND mat.transaction_of = 'hotel'
";
        ...
        <div class="receipt-container">
            ...
            <div class="receipt-header">
                <div class="header-row">
                    ...
                    <div class="receipt-title">Hotel Payment Receipt</div>
            ...
            <div class="receipt-details">
                ...
                <hr>
                <h6><?php echo __('hotel_information'); ?></h6>

                <div class="detail-row">
                    <span class="detail-label"><?php echo __('guest_name'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['guest_name']); ?></span>
                </div>

                <div class="detail-row">
                    <span class="detail-label"><?php echo __('order_id'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['order_id']); ?></span>
                </div>

                <div class="detail-row">
                    <span class="detail-label"><?php echo __('contact'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['contact_no']); ?></span>
                </div>

                <div class="detail-row">
                    <span class="detail-label"><?php echo __('check_in_date'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['check_in_date']); ?></span>
                </div>
                ...
                <div class="detail-row">
                    <span class="detail-label"><?php echo __('accommodation_details'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['accommodation_details']); ?></span>
                </div>

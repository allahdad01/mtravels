...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT id, amount, currency, type, main_account_id, created_at, transaction_of FROM main_account_transactions WHERE reference_id = ? AND transaction_of = 'deposit_sarafi' AND tenant_id = ?");

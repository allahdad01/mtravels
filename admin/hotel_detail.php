                    ...
                    <div class="page-wrapper">
                        ...
                        <?php else: ?>
                            ...
                            <div class="hb-detail-card">
                                ...
                                <div class="hb-detail-grid">
                                    ...
                                    <div class="hb-detail-section">
                                        ...
                                        <div class="hb-detail-row">
                                            <span class="hb-label"><?= __('base_amount') ?></span>
                                            <span class="hb-value"><?= htmlspecialchars($hotelData['currency'] ?? '—') ?> <?= htmlspecialchars($hotelData['base_amount'] ?? '—') ?></span>
                                        </div>
                                        <div class="hb-detail-row">
                                        ...
                                        <div class="hb-detail-row">
                                            <span class="hb-label"><?= __('profit') ?></span>
                                            <span class="hb-value <?= (isset($hotelData['profit']) && $hotelData['profit'] > 0) ? 'hb-text-success' : 'hb-text-danger' ?>">
                                                <?= htmlspecialchars($hotelData['currency'] ?? '—') ?> <?= number_format($hotelData['profit'] ?? 0, 2) ?>
                                            </span>
                                        </div>
                                        <div class="hb-detail-row">
                                            <span class="hb-label"><?= __('exchange_rate') ?></span>
                                            <span class="hb-value"><?= htmlspecialchars($hotelData['exchange_rate'] ?? '—') ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="hb-detail-section">
                                        ...
                                        <div class="hb-detail-row">
                                            <span class="hb-label"><?= __('supplier') ?></span>
                                            <span class="hb-value"><?= htmlspecialchars($hotelData['supplier_name'] ?? '—') ?></span>
                                        </div>
                                        <div class="hb-detail-row">
                                            <span class="hb-label"><?= __('supplier_email') ?></span>
                                            <span class="hb-value"><?= htmlspecialchars($hotelData['supplier_email'] ?? '—') ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="hb-transactions-container">
                                ...
                                <div class="hb-trans-card">
                                    <div class="hb-trans-title">
                                        <i class="feather icon-truck"></i><?= __('supplier_transactions') ?>
                                    </div>
                                    <div class="hb-trans-table">
                                        <div class="hb-trans-row hb-trans-header">
                                            <div><?= __('date') ?></div>
                                ...
                                <div class="hb-trans-card">
                                    <div class="hb-trans-title">
                                        <i class="feather icon-home"></i><?= __('main_account_transactions') ?>
                                    </div>
                                    <div class="hb-trans-table">
                                        <div class="hb-trans-row hb-trans-header">
                                            <div><?= __('date') ?></div>

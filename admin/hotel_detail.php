    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10"><?= __('hotel_booking_details') ?></h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="search.php"><?= __('search') ?></a></li>
                            <li class="breadcrumb-item"><a href="javascript:"><?= __('hotel_booking_details') ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php else: ?>
                    <!-- Hotel Booking Information Card -->
                    <div class="card">
                        <div class="card-header">
                            <h5>
                                <i class="feather icon-home mr-2"></i>
                                <?= __('hotel_booking_information') ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <table class="table table-bordered">
                                        <tr>
                                            <th><?= __('title') ?></th>
                                            <td><?php echo isset($hotelData['title']) && $hotelData['title'] !== null ? 
                                                htmlspecialchars($hotelData['title']) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('first_name') ?></th>
                                            <td><?php echo isset($hotelData['first_name']) && $hotelData['first_name'] !== null ? 
                                                htmlspecialchars($hotelData['first_name']) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('last_name') ?></th>
                                            <td><?php echo isset($hotelData['last_name']) && $hotelData['last_name'] !== null ? 
                                                htmlspecialchars($hotelData['last_name']) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('gender') ?></th>
                                            <td><?php echo isset($hotelData['gender']) && $hotelData['gender'] !== null ? 
                                                htmlspecialchars($hotelData['gender']) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('order_id') ?></th>
                                            <td><?php echo isset($hotelData['order_id']) && $hotelData['order_id'] !== null ? 
                                                htmlspecialchars($hotelData['order_id']) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('check_in_date') ?></th>
                                            <td><?php echo !empty($hotelData['check_in_date']) ? 
                                                date('Y-m-d', strtotime($hotelData['check_in_date'])) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('check_out_date') ?></th>
                                            <td><?php echo !empty($hotelData['check_out_date']) ? 
                                                date('Y-m-d', strtotime($hotelData['check_out_date'])) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('accommodation_details') ?></th>
                                            <td><?php echo isset($hotelData['accommodation_details']) && $hotelData['accommodation_details'] !== null ? 
                                                nl2br(htmlspecialchars($hotelData['accommodation_details'])) : '—'; ?></td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="col-md-6">
                                    <table class="table table-bordered">
                                        <tr>
                                            <th><?= __('issue_date') ?></th>
                                            <td><?php echo !empty($hotelData['issue_date']) ? 
                                                date('Y-m-d', strtotime($hotelData['issue_date'])) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('contact_no') ?></th>
                                            <td><?php echo isset($hotelData['contact_no']) && $hotelData['contact_no'] !== null ? 
                                                htmlspecialchars($hotelData['contact_no']) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('base_amount') ?></th>
                                            <td><?php echo isset($hotelData['currency']) && isset($hotelData['base_amount']) ? 
                                                htmlspecialchars($hotelData['currency']) . ' ' . htmlspecialchars($hotelData['base_amount']) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('sold_amount') ?></th>
                                            <td>
                                                <strong>
                                                    <?php echo isset($hotelData['currency']) && isset($hotelData['sold_amount']) ? 
                                                        htmlspecialchars($hotelData['currency']) . ' ' . htmlspecialchars($hotelData['sold_amount']) : '—'; ?>
                                                </strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><?= __('profit') ?></th>
                                            <td class="<?php echo (isset($hotelData['profit']) && $hotelData['profit'] > 0) ? 'text-success' : 'text-danger'; ?>">
                                                <strong>
                                                    <?php 
                                                    if (isset($hotelData['currency']) && isset($hotelData['profit'])) {
                                                        echo htmlspecialchars($hotelData['currency']) . ' ' . 
                                                            number_format($hotelData['profit'], 2);
                                                    } else {
                                                        echo '—';
                                                    }
                                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo isset($hotelData['exchange_rate']) && $hotelData['exchange_rate'] !== null ? 
                                                htmlspecialchars($hotelData['exchange_rate']) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('created_at') ?></th>
                                            <td><?php echo !empty($hotelData['created_at']) ? 
                                                date('Y-m-d H:i', strtotime($hotelData['created_at'])) : '—'; ?></td>
                                        </tr>
                                        <tr>
                                            <th><?= __('updated_at') ?></th>
                                            <td><?php echo !empty($hotelData['updated_at']) ? 
                                                date('Y-m-d H:i', strtotime($hotelData['updated_at'])) : '—'; ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>

                            <?php if (isset($hotelData['receipt']) && !empty($hotelData['receipt'])): ?>
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <div class="card bg-light">
                                        <div class="card-body">
                                            <h6 class="card-title"><i class="feather icon-file mr-2"></i><?= __('receipt') ?></h6>
                                            <p class="card-text">
                                                <a href="<?php echo htmlspecialchars($hotelData['receipt']); ?>" target="_blank" class="btn btn-sm btn-primary">
                                                    <i class="feather icon-download mr-1"></i> <?= __('view_receipt') ?>
                                                </a>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <?php if (isset($hotelData['sold_to']) && !empty($hotelData['sold_to'])): ?>
                                        <p><strong><?= __('name') ?>:</strong> <?php echo isset($hotelData['client_name']) ? 
                                            htmlspecialchars($hotelData['client_name']) : '—'; ?></p>
                                        <p><strong><?= __('email') ?>:</strong> <?php echo isset($hotelData['client_email']) ? 
                                            htmlspecialchars($hotelData['client_email']) : '—'; ?></p>
                                        <p><strong><?= __('phone') ?>:</strong> <?php echo isset($hotelData['client_phone']) ? 
                                            htmlspecialchars($hotelData['client_phone']) : '—'; ?></p>
                                        <a href="client_detail.php?id=<?php echo h($hotelData['sold_to']); ?>" class="btn btn-sm btn-primary">
                        ...
                        <div class="col-md-6">
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <?php if (isset($hotelData['supplier_id']) && !empty($hotelData['supplier_id'])): ?>
                                        <p><strong><?= __('name') ?>:</strong> <?php echo isset($hotelData['supplier_name']) ? 
                                            htmlspecialchars($hotelData['supplier_name']) : '—'; ?></p>
                                        <p><strong><?= __('email') ?>:</strong> <?php echo isset($hotelData['supplier_email']) ? 
                                            htmlspecialchars($hotelData['supplier_email']) : '—'; ?></p>
                                        <p><strong><?= __('phone') ?>:</strong> <?php echo isset($hotelData['supplier_phone']) ? 
                                            htmlspecialchars($hotelData['supplier_phone']) : '—'; ?></p>
                                        <a href="supplier_detail.php?id=<?php echo h($hotelData['supplier_id']); ?>" class="btn btn-sm btn-primary">
                    ...
                    <?php if (!empty($hotelData['remarks'])): ?>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="card bg-light">
                                <div class="card-body">
                                    <h6 class="card-title"><i class="feather icon-info mr-2"></i><?= __('remarks') ?></h6>
                                    <p class="card-text"><?php echo nl2br(htmlspecialchars($hotelData['remarks'])); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tab-content" id="transactionTabContent">
                            ...
                            <div class="tab-pane fade show active" id="client" role="tabpanel">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge badge-info"><?= __('hotel') ?></span>
                                                </td>
                                ...
                                <div class="alert alert-info">
                                    <?php if (isset($hotelData['sold_to']) && !empty($hotelData['sold_to'])): ?>
                                        <?= __('no_client_transactions_found_for_this_booking') ?>
                                    <?php else: ?>
                                        <?= __('no_client_associated_with_this_booking') ?>
                                    <?php endif; ?>
                                </div>
                                <?php endif; ?>
                            </div>

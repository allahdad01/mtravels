                ...
                <div class="pg-body">
                    ...
                    <div class="kpi-row">
                        <div class="kpi-card">
                            ...
                            <div class="kpi-label"><?= __('total_weights') ?? 'Total weights' ?></div>
                        ...
                        <div class="kpi-card">
                            <div class="kpi-accent" style="background:#185FA5"></div>
                            <div class="kpi-label"><?= __('total_revenue') ?? 'Total revenue' ?></div>
                            <div class="kpi-value"><?= number_format($totalWeightRevenue ?? 0) ?></div>
                            <div class="kpi-sub"><?= __('this_month') ?? 'This month' ?></div>
                        </div>
                    </div>

...
<div class="container">
    <div class="controls no-print">
        <button onclick="window.print();" class="btn">چاپ جریمه لیک</button>
        <button onclick="window.history.back();" class="btn">برگشت</button>
    </div>

    <div class="header">
    <img src="<?php echo htmlspecialchars($logoPath); ?>" alt="لوګو">
    <h1>د <?php echo $settings['agency_name']; ?> شرکت<br>د جریمې لیک</h1>
...
<div class="agreement-body">
    ...
    <div class="clause">
        <h3>د وظیفوي سرغړونې له امله جریمه</h3>
        <p>
            درناوی سره، د مدیریت له خوا د ترسره شوو څېړنو پر اساس، تاسو لاندې وظیفوي سرغړونه کړې ده:<br><br>
            <?php echo $takhaluf; ?><br><br>

            مخکې له دې تاسو ته د تذکر خط (توسعه‌خط) درکړل شوی و، خو د اصلاح اقدام ونه شو. بناءً، د ادارې د انضباطي پالیسۍ مطابق، تاسو ته د لاندې مقدار جریمه وضع کېږي:<br><br>

            <strong>جریمه شوې اندازه:</strong> <?php echo $fine_amount; ?> <?php echo $currency; ?><br><br>

            یادونه: دغه جریمه به له راتلونکې معاش څخه وضع شي. هیله ده چې له دې وروسته به خپلې دندې په مسوولانه ډول ترسره کړئ او د ادارې اصول به رعایت کړئ.

            دا اقدام د نظم د تأمین او د مسؤلیت د درک لپاره ترسره کېږي.
        </p>
    </div>

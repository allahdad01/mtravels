...
<!-- Button Protection for Additional Payments -->
<script>
        ...
        disabledButtons.forEach(button => {
            if (button.innerHTML.includes('spinner')) {
                ...
                if (button.id === 'savePayment') {
                    button.innerHTML = '<?= __("save_payment") ?>';
                } else if (button.id === 'updatePayment') {
                    button.innerHTML = '<?= __("update_payment") ?>';
                } else if (button.id === 'AddTransaction') {
                    button.innerHTML = '<?= __("add_transaction") ?>';
                } else if (button.id === 'updateTransaction') {
                    button.innerHTML = '<?= __("update_transaction") ?>';

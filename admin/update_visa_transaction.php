...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT amount, currency, type, main_account_id, created_at FROM main_account_transactions WHERE id = ? AND transaction_of = 'visa_refund' AND tenant_id = ?");
        ...
        $stmt->bind_param("dsssii", $newAmount, $newDescription, $newDate, $exchange_rate, $transactionId, $tenant_id);

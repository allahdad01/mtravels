...
try {
    ...
    ");
    $getTransactionStmt->execute([$transaction_id, 'deposit', $tenant_id, $branch_id]);
    ...
    ");
    $mainTransactionStmt->execute([$transaction_id, 'deposit_sarafi', $tenant_id, $branch_id]);
    ...
    ");
    $deleteNotifStmt->execute([$mainTransaction['id'], 'deposit_sarafi', $tenant_id, $branch_id]);

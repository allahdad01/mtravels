...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Get booking details
        $stmt = $pdo->prepare("SELECT paid_to, title, passenger_name, pnr FROM date_change_tickets WHERE id = ?");
        ...
        $notifStmt = $pdo->prepare("
            ...
            VALUES (?, 'ticket_date_change', ?, 'Unread', NOW(), ?)
        ");
        ...
        error_log("Error in add_date_change_ticket_payment.php: " . $e->getMessage());

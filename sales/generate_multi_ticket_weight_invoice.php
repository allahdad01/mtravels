...
if (!empty($ticketIds)) {
    ...
    $ticketsQuery = "SELECT tw.id, tw.weight, tw.base_price, tw.sold_price, tw.profit, tb.currency, tw.exchange_rate,
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br><small><?php echo htmlspecialchars($ticket['airline']); ?> - <?php echo date('M j, Y', strtotime($ticket['departure_date'])); ?></small>
                    </td>
                    <td><?php echo number_format($ticket['weight'], 2); ?> kg</td>
                    <td class="amount"><?php echo number_format($ticket['sold_price'], 2); ?></td>
                    <td class="amount">
                        <?php
                        $paidStr = '';

    ...
    function permission_catalog(): array {
        return [
            ...
            'Finance' => [
                ...
                'owner_funds'        => 'Owner payments tracking',
    ...
    function role_default_permissions(?string $role = null): array {
        ...
        $map = [
            ...
            'finance' => [
                ...
                'finance.cash_settlement_approve', 'finance.owner_funds',
            ...
            'sales' => [
                'dashboard.view',
                'tickets.view', 'tickets.book', 'tickets.date_change',
                'tickets.weights', 'tickets.reserve', 'tickets.refund',
                'hotels.view', 'hotels.book', 'hotels.refund',
                'umrah.view', 'umrah.member_create', 'umrah.refund',
                'visa.view', 'visa.create', 'visa.refund',
                'reports.view',
                'hr.salary',
                'communication.view',
                'support.view',
...
if (!function_exists('page_permission_map')) {
    ...
    function page_permission_map(): array {
        return [
            ...
            'customer_advances.php'          => 'finance.expenses',
            ...
            'owner_funds.php'               => 'finance.owner_funds',
            'print_owner_fund_receipt.php'  => 'finance.owner_funds',

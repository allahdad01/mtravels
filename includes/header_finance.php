...
<head>
    ...
    <style>
        ...
        /* CRITICAL FIX: Main container layout */
        ...
        @media (max-width: 991px) {
            ...
            /* Fix header dropdowns on mobile */
            .pcoded-header .dropdown .dropdown-menu {
        ...
        /* CRITICAL FIX: Header Icons and Dropdowns */
        ...
        /* Fix icon alignment */
        html[dir="rtl"] .pcoded-header .navbar-nav > li,
        body.rtl .pcoded-header .navbar-nav > li {
            padding: 0 7px !important;
        }

        /* Language and Settings Icons Container */
        html[dir="rtl"] .pcoded-header .dropdown,
        body.rtl .pcoded-header .dropdown {
            position: relative !important;
        }

        /* Fix dropdown toggle icons and arrows positioning */
        html[dir="rtl"] .pcoded-header .dropdown .dropdown-toggle,
        body.rtl .pcoded-header .dropdown .dropdown-toggle {
            padding: 0 7px !important;
            display: inline-flex !important;
            align-items: center !important;
            flex-direction: row !important; /* Change to normal row direction */
            gap: 5px !important; /* Add consistent gap between icon and arrow */
        }
        ...
        html[dir="rtl"] .pcoded-header .dropdown .dropdown-toggle .feather,
        body.rtl .pcoded-header .dropdown .dropdown-toggle .feather {
            margin: 0 !important;
            padding: 0 !important;
        }

        /* Adjust navbar items spacing */
        html[dir="rtl"] .pcoded-header .navbar-nav > li:not(:first-child),
        body.rtl .pcoded-header .navbar-nav > li:not(:first-child) {
            margin-right: 15px !important;
        }

        /* Fix navbar alignment */
        html[dir="rtl"] .pcoded-header .navbar-nav,
        body.rtl .pcoded-header .navbar-nav {
        ...
        html[dir="rtl"] .pcoded-header .dropdown .feather,
        body.rtl .pcoded-header .dropdown .feather {
            vertical-align: middle !important;
        ...
        html[dir="rtl"] .pcoded-header .icon.feather.icon-globe + .dropdown-menu,
        body.rtl .pcoded-header .icon.feather.icon-globe + .dropdown-menu {
        ...
        html[dir="rtl"] .pcoded-header .drp-user .dropdown-menu,
        body.rtl .pcoded-header .drp-user .dropdown-menu {
            left: 0 !important;
            right: auto !important;
            transform-origin: top left !important;
            margin-top: 0 !important;
        ...
        html[dir="rtl"] .pcoded-header .dropdown-item,
        body.rtl .pcoded-header .dropdown-item {
            text-align: right !important;
            padding: 0.5rem 1rem !important;
        }

        /* Fix icons in dropdown items */
        html[dir="rtl"] .pcoded-header .dropdown-item i,
        body.rtl .pcoded-header .dropdown-item i {
            margin-left: 10px !important;
            margin-right: 0 !important;
            float: right !important;
        }

        /* Fix profile notification dropdown */
        html[dir="rtl"] .profile-notification,
        body.rtl .profile-notification {
        ...
        /* Fix profile header */
        html[dir="rtl"] .profile-notification .pro-head,
        body.rtl .profile-notification .pro-head {
        ...
        html[dir="rtl"] .profile-notification .pro-head img,
        body.rtl .profile-notification .pro-head img {
            margin-left: 10px !important;
            margin-right: 0 !important;
        }

        html[dir="rtl"] .profile-notification .pro-head .dud-logout,
        body.rtl .profile-notification .pro-head .dud-logout {
            margin-right: auto !important;
            margin-left: 0 !important;
        }

        /* Mobile specific fixes for header icons */
        @media (max-width: 991px) {
            html[dir="rtl"] .pcoded-header .navbar-nav.ml-auto,
            body.rtl .pcoded-header .navbar-nav.ml-auto {
                padding-right: 0 !important;
            }

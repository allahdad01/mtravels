...
<div class="pcoded-content">
            ...
            <div class="search-row">
                <div>
                    ...
                    <div class="search-group">
                        <input type="text" id="searchInput" class="form-input" placeholder="Applicant name, passport, country, or visa typeâ€¦" value="<?= htmlspecialchars($search) ?>">
    ...
    <div class="dash-card">
        ...
        <div class="pag-wrap">
            <div class="pag-info">Showing <?= $from ?>â€“<?= $to ?> of <?= number_format($total_applications) ?> visa applications</div>
            <div class="pag-links">

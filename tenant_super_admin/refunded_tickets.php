...
<div class="pcoded-content">
    ...
    <!-- Header — red gradient to signal refunds -->
    ...
    <div class="dash-card">
        ...
        <div class="pag-wrap">
            <div class="pag-info">Showing <?= $from ?>–<?= $to ?> of <?= number_format($total_tickets) ?> refunded tickets</div>
            <div class="pag-links">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-summary">
                <div class="ms-cell"><div class="ms-label">Refund Amount</div><div class="ms-val red" id="refund-amount">—</div></div>
                <div class="ms-cell"><div class="ms-label">Total Penalties</div><div class="ms-val amber" id="total-penalties">—</div></div>
                <div class="ms-cell"><div class="ms-label">Original Price</div><div class="ms-val blue" id="original-price">—</div></div>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="modal-pane active" id="pane-summary">
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
                        ...
                        <div class="detail-section">
                            ...
                            <div class="ds-row"><span class="ds-key">Departure</span><span class="ds-val" id="departure-date">—</span></div>
                ...
                <div class="modal-pane" id="pane-refund">
                    <div class="detail-section">
                        ...
                        <div class="ds-row"><span class="ds-key">Original Sold Price</span><span class="ds-val" id="original-sold">—</span></div>
                        <div class="ds-row"><span class="ds-key">Supplier Penalty</span><span class="ds-val red" id="supplier-penalty">—</span></div>
                        <div class="ds-row"><span class="ds-key">Service Penalty</span><span class="ds-val red" id="service-penalty">—</span></div>
                        <hr class="ds-divider">
                        <div class="ds-row"><span class="ds-key" style="font-weight:700;">Refund to Passenger</span><span class="ds-val green" id="refund-to-passenger">—</span></div>
                        <div class="ds-row"><span class="ds-key">Status</span><span class="ds-val" id="refund-status">—</span></div>
                        <div class="ds-row"><span class="ds-key">Remarks</span><span class="ds-val" id="remarks" style="max-width:240px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">—</span></div>
                    </div>
                </div>
            </div>

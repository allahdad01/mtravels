                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Creditors Management</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="javascript:">Creditors</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-c-blue text-white">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <p class="m-b-5">Total Creditors</p>
                                                <h4 class="m-b-0"><?= number_format($summary['total_creditors'] ?? 0) ?></h4>
                                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-c-green text-white">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <p class="m-b-5">Active Creditors</p>
                                                <h4 class="m-b-0"><?= number_format($summary['active_creditors'] ?? 0) ?></h4>
                                            </div>
                                            <div class="col col-auto text-right">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-c-yellow text-white">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <p class="m-b-5">Average Credit</p>
                                                <h4 class="m-b-0">$<?= number_format($summary['avg_credit_amount'] ?? 0, 2) ?></h4>
                                            </div>
                                            <div class="col col-auto text-right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="status-info">
                                                                <span class="badge badge-<?= $creditor['status'] === 'active' ? 'success' : 'secondary' ?>">

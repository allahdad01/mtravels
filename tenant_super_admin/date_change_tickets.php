...
// Build query for date change tickets
$query = "SELECT
    dct.*,
...
$count_query = "SELECT COUNT(*) as total FROM date_change_tickets dct
                LEFT JOIN ticket_bookings tb ON dct.ticket_id = tb.id
                WHERE dct.tenant_id = ?";
$count_params = [$tenant_id];

if ($branch_filter !== 'all') {
    $count_query .= " AND dct.branch_id = ?";
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Date Change Tickets</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="javascript:">Date Change Tickets</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="date-change-info">
                                                                <div class="date-change-info__old-date">
                                                                    <i class="feather icon-calendar text-muted mr-1"></i>
                                                                    <small>Old: <?= htmlspecialchars($ticket['departure_date']) ?></small>
                                                                </div>
                                                                <div class="date-change-info__status">
                                                                    <span class="badge badge-<?= $ticket['status'] === 'Refunded' ? 'success' : ($ticket['status'] === 'Pending' ? 'warning' : 'secondary') ?>">
                                                        ...
                                                        <td class="text-right">
                                                            <div class="penalty-amount">
                                                                <div class="penalty-amount__supplier text-danger">
                                                                    <small>Supplier: <?= htmlspecialchars($ticket['currency']) ?> <?= number_format($ticket['supplier_penalty'], 2) ?></small>
                                                                </div>
                                                                <div class="penalty-amount__service text-warning">
                                                                    <small>Service: <?= htmlspecialchars($ticket['currency']) ?> <?= number_format($ticket['service_penalty'], 2) ?></small>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div class="card-footer bg-white">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="text-muted">
                                                    Showing <?= min(($page - 1) * $results_per_page + 1, $total_tickets) ?> to <?= min($page * $results_per_page, $total_tickets) ?> of <?= $total_tickets ?> date change tickets
                                                </div>
        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-warning text-white border-0">
                <h5 class="modal-title">
                    <i class="feather icon-calendar mr-2"></i>Date Change Ticket Details
                </h5>
            ...
            <div class="modal-body p-0">
                ...
                <div class="bg-light p-4 border-bottom">
                    <div class="row">
                        <div class="col-md-4 text-center">
                            <div class="small text-muted mb-1">Supplier Penalty</div>
                            <h4 class="mb-0 text-danger" id="supplier-penalty">-</h4>
                        </div>
                        <div class="col-md-4 text-center">
                            <div class="small text-muted mb-1">Service Penalty</div>
                            <h4 class="mb-0 text-warning" id="service-penalty">-</h4>
                        </div>
                        <div class="col-md-4 text-center">
                            <div class="small text-muted mb-1">Total Penalty</div>
                            <h4 class="mb-0 text-danger" id="total-penalty">-</h4>
                        </div>
                    </div>
                </div>
                ...
                <ul class="nav nav-pills nav-fill p-3" id="detailsTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="details-change-tab" data-toggle="tab" href="#details-change" role="tab">
                            <i class="feather icon-calendar mr-2"></i>Date Change Details
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content p-4">
                                ...
                                <div class="card border-0 shadow-sm mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <strong id="original-date">-</strong>
                                        </div>
                                        <div class="d-flex justify-content-between">
                    ...
                    <!-- Date Change Details Tab -->
                    <div class="tab-pane fade" id="details-change" role="tabpanel">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                <h6 class="card-subtitle mb-3 text-muted">Date Change Breakdown</h6>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            <span class="text-muted">Original Base Price</span>
                                            <strong id="original-base">-</strong>
                                        </div>
                                        <div class="d-flex justify-content-between mb-2">
                                            <span class="text-muted">Original Departure Date</span>
                                            <strong id="original-departure">-</strong>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-flex justify-content-between mb-2">
                                            <span class="text-muted">Supplier Penalty</span>
                                            <strong class="text-danger" id="supplier-penalty-detail">-</strong>
                                        </div>
                                        <div class="d-flex justify-content-between mb-2">
                                            <span class="text-muted">Service Penalty</span>
                                            <strong class="text-danger" id="service-penalty-detail">-</strong>
                                        </div>
                                        <div class="d-flex justify-content-between mb-2">
                                            <span class="text-muted">Status</span>
                                            <strong id="change-status">-</strong>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                <div class="d-flex justify-content-between">
                                    ...
                                    <strong id="change-remarks">-</strong>
                                </div>
                            </div>
                        </div>
                    </div>
...
document.querySelectorAll('.view-details').forEach(button => {
    button.addEventListener('click', function() {
        ...
        document.getElementById('total-penalty').textContent = ticketData.currency + ' ' + totalPenalty.toFixed(2);
        ...
        document.getElementById('original-date').textContent = ticketData.departure_date || 'N/A';
        document.getElementById('issue-date').textContent = ticketData.issue_date || 'N/A';

        document.getElementById('original-sold').textContent = ticketData.currency + ' ' + parseFloat(ticketData.sold || 0).toFixed(2);
        document.getElementById('original-base').textContent = ticketData.currency + ' ' + parseFloat(ticketData.base || 0).toFixed(2);
        document.getElementById('original-departure').textContent = ticketData.departure_date || 'N/A';
        document.getElementById('supplier-penalty-detail').textContent = ticketData.currency + ' ' + supplierPenalty.toFixed(2);
        document.getElementById('service-penalty-detail').textContent = ticketData.currency + ' ' + servicePenalty.toFixed(2);
        document.getElementById('change-status').textContent = ticketData.status || 'N/A';
        document.getElementById('change-remarks').textContent = ticketData.remarks || 'No remarks';

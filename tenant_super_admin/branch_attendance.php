...
// Check if user is logged in and is tenant super admin
...
$query = "
    SELECT a.*, u.name as user_name, u.email, b.name as branch_name
    FROM attendance a
...
// Get users for filter dropdown (from all branches)
$stmt = $pdo->prepare("
    SELECT DISTINCT u.id, u.name, b.name as branch_name
    FROM users u
    JOIN branches b ON u.branch_id = b.id
    WHERE u.tenant_id = ? AND u.fired = 0
...
$page_title = __('branch_attendance_overview');
?>
                        ...
                        <div class="main-content">
                            <div class="page-header card">
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <h5 class="mb-0"><i class="feather icon-calendar mr-2"></i><?php echo __('branch_attendance_overview'); ?></h5>
                                        <p class="mb-0 mt-1" style="font-size: 14px; opacity: 0.9;"><?php echo __('view_attendance_across_all_branches'); ?></p>
                                    </div>
                                    <div class="col-md-6 text-end">
                                        <span class="badge badge-primary"><?php echo date('F Y', strtotime($month . '-01')); ?></span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <form method="GET" class="row g-3">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select class="form-control" name="branch">
                                                <option value="0"><?php echo __('all_branches'); ?></option>
                                            ...
                                            <select class="form-control" name="user">
                                                ...
                                                <?php foreach ($users as $user): ?>
                                                    <option value="<?php echo $user['id']; ?>" <?php echo $user_filter == $user['id'] ? 'selected' : ''; ?>>
                                                        <?php echo htmlspecialchars($user['name'] . ' (' . $user['branch_name'] . ')'); ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body table-border-style">
                                    <div class="table-responsive">
                                        <table id="attendance-tab" class="table table-hover">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php foreach ($attendance_records as $record): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="badge badge-secondary"><?php echo htmlspecialchars($record['branch_name']); ?></span>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <span class="status status-<?php echo strtolower($record['status']); ?>">
...
function exportAttendance() {
    ...
    const branch = '<?php echo $branch_filter; ?>';
    const user = '<?php echo $user_filter; ?>';
    const status = '<?php echo $status_filter; ?>';

    window.open(`../api/attendance/export_attendance.php?month=${month}&branch=${branch}&user=${user}&status=${status}`, '_blank');
}
</script>

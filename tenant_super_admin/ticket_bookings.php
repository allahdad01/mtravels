...
$count_query = "SELECT COUNT(*) as total FROM ticket_bookings tb WHERE tb.tenant_id = ?";
$count_params = [$tenant_id];

if ($branch_filter !== 'all') {
    $count_query .= " AND tb.branch_id = ?";
                    ...
                    <div class="page-wrapper">
                        ...
                        <div class="main-content">
                            <div class="page-header card">
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <h5 class="mb-0"><i class="feather icon-clipboard mr-2"></i>Ticket Bookings</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5><i class="feather icon-list mr-2"></i>Ticket Bookings</h5>
                                    </div>
                                    <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <div class="ticket-amount">
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if ($ticket['date_change_penalties'] > 0): ?>
                                                                    <div class="ticket-amount__date-change text-warning">
                                                                        <small>
                                                                            Date Change: <?= htmlspecialchars($ticket['currency']) ?> <?= number_format($ticket['date_change_penalties'], 2) ?>
                                                                        </small>
                                                                    </div>
                                                                <?php endif; ?>
                                                                <?php if ($ticket['weight_items_count'] > 0): ?>
                                                                    <div class="ticket-amount__weight text-info">
                                                                        <small>
                                                                            Weight: <?= $ticket['weight_items_count'] ?> items, <?= number_format($ticket['total_weight_count'], 2) ?> kg
                                                                        </small>
                                                                    </div>
                                                                <?php endif; ?>
                                                            </div>
                                        ...
                                        <div class="card-footer bg-white">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="text-muted">
                                                    Showing <?= min(($page - 1) * $results_per_page + 1, $total_tickets) ?> to <?= min($page * $results_per_page, $total_tickets) ?> of <?= $total_tickets ?> tickets
                                                </div>

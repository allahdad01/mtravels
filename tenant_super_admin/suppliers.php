...
.dash-header{background:linear-gradient(135deg,#334155 0%,#4f46e5 100%);border-radius:var(--radius);padding:24px 28px;margin-bottom:24px;display:flex;align-items:center;justify-content:space-between;box-shadow:0 8px 32px rgba(51,65,85,0.25);position:relative;overflow:hidden}
...
.stat-card.total  {background:linear-gradient(135deg,#334155,#4f46e5);box-shadow:0 6px 20px rgba(51,65,85,0.3)}
.stat-card.owed-by{background:linear-gradient(135deg,#059669,#10b981);box-shadow:0 6px 20px rgba(5,150,105,0.3)}
.stat-card.owed-to{background:linear-gradient(135deg,#dc2626,#ef4444);box-shadow:0 6px 20px rgba(220,38,38,0.3)}
...
.dash-card-head h6 .ico{width:28px;height:28px;border-radius:8px;background:linear-gradient(135deg,#334155,#4f46e5);display:flex;align-items:center;justify-content:center;color:#fff;font-size:13px;flex-shrink:0}
...
.search-btn{display:inline-flex;align-items:center;gap:6px;background:linear-gradient(135deg,#334155,#4f46e5);color:#fff;border:none;border-radius:10px;padding:9px 18px;font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;white-space:nowrap;flex-shrink:0;transition:opacity .2s}
...
.pag-btn.active{background:linear-gradient(135deg,#334155,#4f46e5);border-color:transparent;color:#fff}
...
.modal-header{background:linear-gradient(135deg,#334155,#4f46e5);color:#fff;border-radius:16px 16px 0 0;border:none;padding:18px 24px}
.modal-header.txn-header{background:linear-gradient(135deg,#4f46e5,#7c3aed)}
...
<div class="pcoded-content">
    ...
    <div class="dash-card">
        ...
        <div class="pag-wrap">
            <div class="pag-info">Showing <?= $from ?>–<?= $to ?> of <?= number_format($total_suppliers) ?> suppliers</div>
            <div class="pag-links">

...
try {
    $stmt = $pdo->prepare("SELECT id, name FROM clients WHERE id = ? AND tenant_id = ?");
...
<!-- Meta tags for client report context -->
<meta name="current-client-id" content="<?= htmlspecialchars($client_id) ?>">
<meta name="current-client-name" content="<?= htmlspecialchars($client_name) ?>">
                                            ...
                                            <div class="card-body p-4 p-lg-5">
                                                <form id="reportForm">
                                                    ...
                                                    <div class="form-section mb-4">
                                                        ...
                                                        <div class="row g-3">
                                                            <!-- Report Type Selection - Hidden, only client type -->
                                                            <input type="hidden" id="reportType" value="client">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group custom-form-group">
                                                                    ...
                                                                    <input type="text" id="currentClientName" class="form-control form-control-lg" readonly>
                                                    ...
                                                    <!-- Entity Selection Section - Hidden for client reports -->
                                                    <div class="form-section mb-4" id="entitySection" style="display: none;">
                                                        <input type="hidden" id="entity">
                                                    </div>

                                                    <!-- Report Configuration Section -->
                                                    <div class="form-section mb-4" id="reportConfigSection">
                                                        <div class="section-header mb-3">
                                                            <h6 class="text-primary mb-0 fw-bold">
                                                        ...
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-lg-6" id="reportCategorySelection">
                                                                <div class="form-group custom-form-group">
                                                                    <label class="form-label fw-semibold text-muted mb-2">

...
// enforce_client_auth() is called automatically in security.php
          ...
          <div class="page-wrapper">
            <div class="main-content">
              ...
              <div class="td-page-header">
                ...
                <a href="ticket.php" class="td-back-btn">
                  <i class="feather icon-arrow-left"></i><?php echo __('back_to_tickets'); ?>
                </a>
              </div>
                ...
                <div class="acc-item" id="acc-refund">
                  ...
                  <div class="acc-body">
                    <div class="acc-grid">
                      ...
                      <div class="acc-field">
                        <div class="acc-field-label"><?php echo __('charges'); ?></div>
                        <div class="acc-field-value"><?php echo htmlspecialchars($refundData['currency']) . ' ' . htmlspecialchars($refundData['supplier_penalty']) +  htmlspecialchars($refundData['service_penalty']); ?></div>
                      </div>
                ...
                <div class="acc-item" id="acc-datechange">
                  ...
                  <div class="acc-body">
                    <div class="acc-grid">
                      ...
                      <div class="acc-field">
                        <div class="acc-field-label"><?php echo __('charges'); ?></div>
                        <div class="acc-field-value"><?php echo htmlspecialchars($dateChangeData['currency']) . ' ' . htmlspecialchars($dateChangeData['supplier_penalty']) +  htmlspecialchars($refundData['service_penalty']); ?></div>
                      </div>
              ...
              <div class="trans-card">
                <div class="trans-card-header">
                  ...
                  <span style="margin-left:auto;font-size:.75rem;opacity:.7;font-weight:400;">
                    <?php echo count($clientTransactions); ?> <?php echo __('entries'); ?>
                  </span>
                </div>

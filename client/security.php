...
/**
 * Central Security Module for client Panel
 * 
 * This file should be included at the top of every client page to enforce security best practices.
 */
...
// Define allowed roles for client panel
$client_roles = ['client', 'finance'];
...
function check_auth($allowed_roles = null) {
    ...
    // If no specific roles are provided, use the global client roles

...
-- Generated on: 2025-12-07 08:02:30
...
-- Total rows in `activity_log`: 274
...
-- Total rows in `additional_payments`: 2
...
-- Total rows in `cancellation_reapply_log`: 6
...
-- Total rows in `client_transactions`: 41
...
-- Total rows in `creditor_transactions`: 19
...
-- Total rows in `debtor_transactions`: 6
...
-- Total rows in `email_tracking`: 44
...
-- Total rows in `login_history`: 25
...
-- Total rows in `main_account_transactions`: 175
...
-- Total rows in `notifications`: 170
...
-- Total rows in `refunded_tickets`: 3
...
-- Total rows in `supplier_transactions`: 51
...
-- Total rows in `ticket_bookings`: 13

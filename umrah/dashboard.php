...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'umrah') {
    // Log unauthorized access attempt
    error_log("Unauthorized access attempt to umrah dashboard: " . ($_SESSION['user_id'] ?? 'unknown') . " - IP: " . $_SERVER['REMOTE_ADDR']);
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <div class="dashboard-header d-flex justify-content-between align-items-center flex-wrap">
                                        <div>
                                            <h3 class="dashboard-title"><?= __('welcome_back') ?>, <?= htmlspecialchars($user['name'] ?? 'umrah') ?></h3>

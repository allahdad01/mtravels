...
<head>
    <meta charset="UTF-8">
    <title>Visa Refund Agreement</title>
    <style>
        @page {
            size: A4;
            margin: 0.8cm;
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="header-center">
                ...
                <div class="title">Visa Refund Agreement</div>
            </div>
    ...
    <div class="section">
        ...
        <table class="details-table">
            <tr>
                <td>Visa ID</td>
                <td><?= htmlspecialchars($refund['visa_id']) ?></td>
            </tr>
            <tr>
                <td>Applicant Name</td>
                <td><?= htmlspecialchars($refund['applicant_name']) ?></td>
            </tr>
            <tr>
                <td>Passport Number</td>
                <td><?= htmlspecialchars($refund['passport_number']) ?></td>
            </tr>
            <tr>
                <td>Country</td>
                <td><?= htmlspecialchars($refund['country']) ?></td>
            </tr>
            <tr>
                <td>Application Date</td>
                <td><?= date('F d, Y', strtotime($refund['applied_date'])) ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <table class="details-table">
            ...
            <tr>
                <td>Exchange Rate</td>
                <td><?= number_format($refund['exchange_rate'], 4) ?></td>
            </tr>
            <tr>
                <td>Equivalent Amount</td>
                <td>
                    <?= $refund['currency'] === 'USD' ? 'AFS' : 'USD' ?> 
                    <?= number_format($refund['refund_amount'] * ($refund['currency'] === 'USD' ? $refund['exchange_rate'] : 1/$refund['exchange_rate']), 2) ?>
                </td>
            </tr>
            <?php endif; ?>
            <tr>
    ...
    <div class="terms">
        ...
        <ol>
            ...
            <li>The refund amount will be processed according to the company's visa refund policy.</li>
            ...
            <li>This refund does not guarantee future visa application approvals.</li>
        </ol>
    </div>
    ...
    <div class="signatures">
        <div class="signature-box">
            <div class="signature-line">
                ...
                Name: <?= htmlspecialchars($refund['applicant_name']) ?>
            </div>
        </div>
        <div class="signature-box">
            <div class="signature-line">

...
try {
    ...
    $getTransactionStmt = $pdo->prepare("
        ...
        WHERE t.id = ? AND t.transaction_of = ? AND t.tenant_id = ? AND t.branch_id = ?
    ");
    $getTransactionStmt->execute([$transaction_id, 'ticket_sale', $tenant_id, $branch_id]);
    ...
    $ticket_id = $transaction['reference_id'];
    ...
    $deleteStmt = $pdo->prepare("
        ...
        AND tenant_id = ? AND branch_id = ?
    ");
    $deleteResult = $deleteStmt->execute([$transaction_id, $ticket_id, 'ticket_sale', $tenant_id, $branch_id]);

...
<div class="receipt">
    ...
    <header class="header">
        ...
        <div class="receipt-title">
            <h2>ADDITIONAL PAYMENT RECEIPT</h2>
            <p>OFFICIAL TRANSACTION</p>
        </div>
    </header>
    ...
    <section class="main-row">
        <div class="client-box">
            ...
            <div class="client-name">
                <?php echo htmlspecialchars($transaction['client_name'] ?? $transaction['supplier_name'] ?? __('payment_transaction')); ?>
            </div>
        </div>
    ...
    <section class="description">
        ...
        <div class="ticket-info">
            <div class="label"><?php echo __('additional_payment_information'); ?></div>
            <div class="ticket-grid">
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('payment_type'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['payment_type']); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('payment_description'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['payment_description']); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('main_account'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['main_account_name'] ?? 'N/A'); ?></div>
                </div>
            </div>
        </div>
        <?php endif; ?>

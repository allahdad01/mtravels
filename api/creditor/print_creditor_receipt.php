...
// Fetch transaction details with creditor information
$query = "
    SELECT
        mat.*,
        d.name as creditor_name,
        d.email as creditor_email,
        d.phone as creditor_phone,
        d.address as creditor_address,
        d.balance as creditor_balance,
        d.currency as creditor_currency,

        ma.name as main_account_name
    FROM main_account_transactions mat
    LEFT JOIN creditor_transactions dt ON mat.reference_id = dt.id AND mat.transaction_of = 'creditor'
    LEFT JOIN creditors d ON dt.creditor_id = d.id
...
<title><?php echo __('creditor_receipt'); ?> - <?php echo htmlspecialchars($transaction['description']); ?></title>
<style>
...
<div class="receipt">
    ...
    <section class="main-row">
        <div class="client-box">
            <div class="label"><?php echo __('creditor'); ?> / <?php echo __('account'); ?></div>
            <div class="client-name">
                <?php echo htmlspecialchars($transaction['creditor_name'] ?? ''); ?>
            </div>
        </div>
    ...
    <section class="description">
        ...
        <div class="ticket-info">
            <div class="label"><?php echo __('creditor_information'); ?></div>
            <div class="ticket-grid">
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('creditor_name'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['creditor_name']); ?></div>
                </div>
                <?php if (!empty($transaction['creditor_email'])): ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('email'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['creditor_email']); ?></div>
                </div>
                <?php endif; ?>
                <?php if (!empty($transaction['creditor_phone'])): ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('phone'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['creditor_phone']); ?></div>
                </div>
                <?php endif; ?>
                <?php if (!empty($transaction['client_name'])): ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('linked_client'); ?></div>

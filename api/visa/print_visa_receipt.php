...
<div class="receipt">
    ...
    <section class="description">
        ...
        <div class="ticket-info">
            <div class="label"><?php echo __('visa_information'); ?></div>
            <div class="ticket-grid">
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('applicant_name'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['applicant_name'] ?? 'N/A'); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('passport_number'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['passport_number'] ?? 'N/A'); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('country'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['country'] ?? 'N/A'); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('visa_type'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['visa_type'] ?? 'N/A'); ?></div>
                </div>
                <?php if (!empty($transaction['issued_date'])): ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('issued_date'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['issued_date']); ?></div>
                </div>
                <?php endif; ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('client'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['client_name'] ?? 'N/A'); ?></div>
                </div>
            </div>
        </div>
        <?php endif; ?>

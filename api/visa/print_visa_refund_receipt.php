...
// Fetch transaction details with refund information
$query = "
    SELECT
        mat.*,
        vr.id as refund_id,
    ...
    LEFT JOIN visa_refunds vr ON mat.reference_id = vr.id AND mat.transaction_of = 'visa_refund'
    ...
    <div class="container-fluid">
        <div class="receipt-container">
            ...
            <div class="receipt-details">
                ...
                <?php if (!empty($transaction['refund_id'])): ?>
                <hr>
                <h6><?php echo __('visa_refund_details'); ?></h6>

                <div class="detail-row">
                    <span class="detail-label"><?php echo __('applicant_name'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['applicant_name']); ?></span>
                </div>

                <div class="detail-row">
                    <span class="detail-label"><?php echo __('passport_number'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['passport_number']); ?></span>
                </div>

                <div class="detail-row">
                    <span class="detail-label"><?php echo __('country'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['country']); ?></span>
                </div>

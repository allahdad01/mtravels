...
if (!empty($ticketIds)) {
    ...
    $ticketsQuery = "SELECT ap.id, ap.applicant_name, ap.passport_number, ap.visa_type, ap.country, ap.applied_date, ap.issued_date, ap.sold
...
// --- 4. Fetch paid amounts for visa applications ---
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Applied Date</th>
                    <th>Issued Date</th>
                    <th class="amount">Amount (<?php echo h($currency); ?>)</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($ticket['applicant_name']); ?></td>
                    <td><?php echo htmlspecialchars($ticket['passport_number']); ?></td>
                    <td>
                        <?php echo htmlspecialchars($ticket['visa_type']); ?>
                    </td>
                    <td>
                        <?php echo htmlspecialchars($ticket['country']); ?>
                    </td>
                    <td><?php echo htmlspecialchars($ticket['applied_date']); ?></td>
                    <td><?php echo htmlspecialchars($ticket['issued_date']); ?></td>
                    <td class="amount"><?php echo number_format($ticket['sold'], 2); ?></td>
                    <td class="amount">
                        <?php
                        $paidStr = '';

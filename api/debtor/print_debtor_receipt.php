...
<div class="receipt">
    ...
    <section class="main-row">
        <div class="client-box">
            <div class="label"><?php echo __('debtor'); ?> / <?php echo __('account'); ?></div>
            <div class="client-name">
                <?php echo htmlspecialchars($transaction['debtor_name'] ?? __('walking_customer')); ?>
            </div>
        </div>
    ...
    <section class="description">
        ...
        <div class="ticket-info">
            <div class="label"><?php echo __('debtor_information'); ?></div>
            <div class="ticket-grid">
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('debtor_name'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['debtor_name']); ?></div>
                </div>
                <?php if (!empty($transaction['debtor_email'])): ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('email'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['debtor_email']); ?></div>
                </div>
                <?php endif; ?>
                <?php if (!empty($transaction['debtor_phone'])): ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('phone'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['debtor_phone']); ?></div>
                </div>
                <?php endif; ?>
                <?php if (!empty($transaction['debtor_address'])): ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('address'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['debtor_address']); ?></div>
                </div>
                <?php endif; ?>
            </div>
        </div>

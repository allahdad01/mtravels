...
$statement_ref = 'ST-' . strtoupper(substr(md5($debtor_id . date('Y')), 0, 8));
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .summary-card.card-balance::before { background: var(--crimson); }
        ...
        .summary-card.card-balance .card-value { color: var(--crimson); }
        ...
        .tl-dot.credit svg { color: var(--green); }
        .tl-dot.debit  svg { color: var(--crimson); }
        ...
        .tl-type.credit { color: var(--green); }
        .tl-type.debit  { color: var(--crimson); }
        ...
        .tl-amount.credit { color: var(--green); }
        .tl-amount.debit  { color: var(--crimson); }
        ...
        @media print {
            ...
            .tl-dot, .summary-card::before, .tl-card { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
            .paid-stamp { display: <?php echo $is_fully_paid ? 'block' : 'none'; ?>; }
            @page { size: A4; margin: 12mm; }
        }

        @media (max-width: 600px) {
            .header, .debtor-strip, .summary-section,
            .timeline-section, .agreement-section, .footer { padding-left: 22px; padding-right: 22px; }
        }
    </style>
</head>
<body>
...
<div class="page">
    ...
    <div class="header">
        ...
        <div class="header-right">
            <div class="doc-title">Debtor Statement</div>
            <div class="doc-meta">
    ...
    <div class="debtor-strip">
        ...
        <div class="info-cell">
            ...
            <div class="value"><?= htmlspecialchars($debtor['email'] ?: 'N/A') ?></div>
        </div>
        <div class="info-cell">
            <div class="label">Phone</div>
            <div class="value"><?= htmlspecialchars($debtor['phone'] ?: 'N/A') ?></div>
        </div>
        <div class="info-cell">
            <div class="label">Address</div>
            <div class="value"><?= htmlspecialchars($debtor['address'] ?: 'N/A') ?></div>
        </div>
    </div>
    ...
    <div class="summary-section">
        <div class="summary-card">
            <div class="card-label">Initial Debt</div>
        ...
        <div class="summary-card card-balance">
            ...
            <div class="card-value"><?= $currency_symbol ?>&nbsp;<?= number_format($debtor['balance'], 2) ?></div>
        </div>
    ...
    <div class="agreement-section" style="padding-top: 28px;">
    ...
    <div class="timeline-section">
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                <!-- dot -->
                <div class="tl-dot <?= $is_credit ? 'credit' : 'debit' ?>">
                    <?php if ($is_credit): ?>
                    <!-- arrow-down-circle for payment -->
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                        <line x1="12" y1="5" x2="12" y2="19"/><polyline points="19 12 12 19 5 12"/>
                    </svg>
                    <?php else: ?>
                    <!-- arrow-up-circle for debt -->
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="tl-card">
                    ...
                    <div class="tl-right">
                        <div class="tl-type <?= $is_credit ? 'credit' : 'debit' ?>"><?= $is_credit ? 'Payment' : 'Debt' ?></div>
                        <div class="tl-amount <?= $is_credit ? 'credit' : 'debit' ?>"><?= $currency_symbol ?> <?= number_format($transaction['amount'], 2) ?></div>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
        ...
        <div class="no-transactions">
            <svg style="width:40px;height:40px;color:var(--border);margin-bottom:10px;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><line x1="8" y1="12" x2="16" y2="12"/></svg>

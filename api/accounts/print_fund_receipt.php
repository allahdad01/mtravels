...
<div class="receipt">
    ...
    <header class="header">
        ...
        <div class="receipt-title">
            <h2><?php echo $transactionTitle; ?></h2>
            <p>OFFICIAL FUND TRANSACTION</p>
        </div>
    </header>
    ...
    <section class="main-row">
        <div class="client-box">
            ...
            <div class="client-name">
                <?php echo htmlspecialchars($transaction['supplier_name'] ?? $transaction['client_name'] ?? __('fund_transaction')); ?>
            </div>
        </div>
    ...
    <section class="description">
        ...
        <div class="ticket-info">
            <div class="label"><?php echo __('transaction_information'); ?></div>
            <div class="ticket-grid">
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('transaction_type'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['transaction_of']); ?></div>
                </div>
                <?php if (!empty($transaction['supplier_name'])): ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('supplier_name'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['supplier_name']); ?></div>
                </div>
                <?php endif; ?>
                <?php if (!empty($transaction['client_name'])): ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('client_name'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['client_name']); ?></div>
                </div>
                <?php endif; ?>
                <?php if (!empty($transaction['remarks'])): ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('remarks'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['remarks']); ?></div>
                </div>
                <?php endif; ?>
            </div>
        </div>

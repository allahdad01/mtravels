...
try {
    ...
    LEFT JOIN ticket_bookings tb ON rt.ticket_id = tb.id AND tb.tenant_id = :tenant_id_tb AND tb.branch_id = :branch_id_tb
    LEFT JOIN main_account ma ON rt.paid_to = ma.id AND ma.tenant_id = :tenant_id_ma AND ma.branch_id = :branch_id_ma

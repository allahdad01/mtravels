...
try {
    ...
    try {
        $dateChangeQuery = "
            ...
            WHERE c.client_type = 'agency' AND dc.tenant_id = :tenant_id AND dc.branch_id = :branch_id AND dc.imported = '0'
        ";
    ...
    try {
        $refundedTicketQuery = "
            ...
            WHERE c.client_type = 'agency' AND rt.tenant_id = :tenant_id AND rt.branch_id = :branch_id AND rt.imported = '0'
        ";
    ...
    try {
        $umrahQuery = "
            ...
            WHERE c.client_type = 'agency' AND u.status = 'active' AND u.tenant_id = :tenant_id AND u.branch_id = :branch_id AND u.imported = '0'
        ";
    ...
    try {
        $visaQuery = "
            ...
            WHERE c.client_type = 'agency' AND v.status != 'refunded' AND v.status != 'Cancelled' AND v.tenant_id = :tenant_id AND v.branch_id = :branch_id AND v.imported = '0'
        ";
    ...
    try {
        $hotelQuery = "
            ...
            WHERE c.client_type = 'agency' AND h.status = 'active' AND h.tenant_id = :tenant_id AND h.branch_id = :branch_id AND h.imported = '0'
        ";
    ...
    try {
        $additionalPaymentsQuery = "
            ...
            WHERE (c.client_type = 'agency' OR ap.client_id IS NULL) AND ap.tenant_id = :tenant_id AND ap.branch_id = :branch_id
        ";

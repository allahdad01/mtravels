...
if (!isset($invoiceData['tickets']) || !is_array($invoiceData['tickets']) || count($invoiceData['tickets']) === 0) {
    die('No weight records selected for invoice');
}
...
if (!empty($ticketIds)) {
    ...
    $ticketsQuery = "SELECT tw.id, tw.weight, tw.base_price, tw.sold_price, tw.profit, tb.currency,
...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .weight-table thead tr { background: var(--navy); }
        ...
        .weight-table thead th:first-child { border-radius: var(--radius) 0 0 0; }
        .weight-table thead th:last-child  { border-radius: 0 var(--radius) 0 0; text-align: right; }
        .weight-table thead th.r { text-align: right; }

        .weight-table tbody tr { transition: background 0.12s; }
        .weight-table tbody tr:nth-child(even) { background: var(--gray-100); }
        .weight-table tbody tr:hover { background: var(--accent-lt); }
        ...
        .weight-table tbody td.r { text-align: right; }
        ...
        .flight-main { font-weight: 500; color: var(--navy); }
        .flight-sub {
            font-size: 11px;
            color: var(--gray-400);
            margin-top: 3px;
        ...
        @media print {
            ...
            .weight-table tbody tr:hover { background: inherit; }
        }
    </style>
</head>
<body>
    ...
    <div class="invoice">
        ...
        <div class="inv-header">
            ...
            <div class="inv-meta">
                <div class="inv-label">Baggage Weight Invoice</div>
        ...
        <div class="inv-body">
            ...
            <div class="summary-pills">
                ...
                <div class="pill">
                    <span class="pill-label">Total Weight</span>
                    <span class="pill-value"><?php echo number_format($totalWeight, 2); ?> kg</span>
                </div>
                <div class="pill">
            ...
            <!-- Weights Table -->
            <div class="section-title">Baggage Weight Details</div>
            <table class="weight-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="flight-sub">
                                ...
                                &mdash; <?php echo date('d M Y', strtotime($ticket['departure_date'])); ?>
                            </div>
                        </td>
                        <td class="r">
                            <span class="weight-badge">
                                &#9878; <?php echo number_format($ticket['weight'], 2); ?> kg
                            </span>
                        </td>
                        <td class="r amount-cell"><?php echo number_format($ticket['sold_price'], 2); ?></td>
                    ...
                    <tr class="totals-row">
                        ...
                        <td class="r">
                            <div class="totals-weight"><?php echo number_format($totalWeight, 2); ?> kg</div>
                        </td>
                        <td class="r">

...
<div class="receipt">
    ...
    <div class="no-print">
        <button onclick="window.print()" style="background:#e67e22;color:white;border:none;padding:10px 20px;border-radius:6px;cursor:pointer;font-size:14px;font-weight:600;">
            &#128424; <?php echo __('print'); ?>
        </button>
    ...
    <header class="header">
        ...
        <div class="receipt-title">
            <h2>DATE CHANGE</h2>
            <p>TICKET MODIFICATION RECEIPT</p>
        </div>
    </header>
    ...
    <section class="description">
        ...
        <div class="ticket-info">
            <div class="label"><?php echo __('date_change_ticket_information'); ?></div>
            <div class="ticket-grid">
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('passenger_name'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['passenger_name'] ?? 'N/A'); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('pnr'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['pnr'] ?? 'N/A'); ?></div>
                </div>
                <div class="ticket-item">
                ...
                <div class="ticket-item">
                    ...
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['airline'] ?? 'N/A'); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('new_departure_date'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['departure_date'] ?? 'N/A'); ?></div>
                </div>
                <div class="ticket-item">

...
if (!isset($invoiceData['tickets']) || !is_array($invoiceData['tickets']) || count($invoiceData['tickets']) === 0) {
    die('No date change records selected for invoice');
}
...
// Fetch paid amounts
$paidQuery = "SELECT reference_id, currency, SUM(amount) as paid FROM main_account_transactions WHERE transaction_of = 'date_change' AND reference_id IN ($placeholders) AND type = 'credit' AND tenant_id = ? AND branch_id = ? GROUP BY reference_id, currency";
...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dc-table thead tr { background: var(--navy); }
        .dc-table thead th {
            padding: 11px 13px;
            text-align: left;
            font-size: 10px;
        ...
        .dc-table thead th:first-child { border-radius: var(--radius) 0 0 0; }
        .dc-table thead th:last-child  { border-radius: 0 var(--radius) 0 0; text-align: right; }
        .dc-table thead th.r { text-align: right; }

        .dc-table tbody tr { transition: background 0.12s; }
        .dc-table tbody tr:nth-child(even) { background: var(--gray-100); }
        .dc-table tbody tr:hover { background: var(--accent-lt); }
        .dc-table tbody td {
            padding: 13px 13px;
        ...
        .dc-table tbody td.r { text-align: right; }
        ...
        /* Charge amount — amber to signal penalty */
        .charge-cell {
            font-family: 'DM Mono', monospace;
            font-weight: 600;
            color: var(--warn);
        ...
        @media print {
            ...
            .dc-table tbody tr:hover { background: inherit; }
        }
    </style>
</head>
<body>
    ...
    <div class="invoice">
        ...
        <div class="inv-header">
            ...
            <div class="inv-meta">
                <div class="inv-label">Date Change Invoice</div>
        ...
        <div class="warn-notice">
            ...
            This invoice covers date change penalty charges applied to the tickets listed below.
        </div>
        ...
        <div class="inv-body">
            ...
            <!-- Date Change Table -->
            <div class="section-title">Date Change Charge Details</div>
            <table class="dc-table">
                <thead>
                    <tr>
                        ...
                        <th>New Departure</th>
                        <th>Airline</th>
                        <th class="r">Charges (<?php echo h($currency); ?>)</th>
                        <th class="r">Paid</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="new-date">
                                &#128197; <?php echo !empty($ticket['departure_date']) ? date('d M Y', strtotime($ticket['departure_date'])) : h($ticket['departure_date']); ?>
                            </span>
                        </td>
                        <td>
                        ...
                        <td class="r charge-cell"><?php echo number_format($ticket['charges'], 2); ?></td>
                    ...
                    <tr class="totals-row">
                        ...
                        <td style="text-align:right">
                            <div class="totals-label">Total Charges</div>
                        </td>
                        <td class="r">

...
// Fetch transaction details with refund ticket information
$query = "
    SELECT
        mat.*,
        rt.id as ticket_id,
        ...
        rt.departure_date,
        rt.sold,
        rt.currency as ticket_currency,
        rt.supplier_penalty,
        rt.service_penalty,
    ...
    LEFT JOIN refunded_tickets rt ON mat.reference_id = rt.id AND mat.transaction_of = 'ticket_refund'
...
<div class="receipt">
    ...
    <div class="no-print">
        <button onclick="window.print()" style="background:#dc3545;color:white;border:none;padding:10px 20px;border-radius:6px;cursor:pointer;font-size:14px;font-weight:600;">
            &#128424; <?php echo __('print'); ?>
        </button>
    ...
    <section class="main-row">
        ...
        <div class="amount-box">
            <div class="label"><?php echo __('refund_amount'); ?></div>
            <div class="amount">
    ...
    <section class="description">
        ...
        <div class="ticket-info">
            <div class="label"><?php echo __('refund_ticket_information'); ?></div>
    ...
    <footer class="footer">
        ...
        <div class="status">
            ...
            <div class="status-value"><?php echo __('refund_confirmed'); ?></div>

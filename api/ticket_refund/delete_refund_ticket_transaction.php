...
try {
    ...
    ");
    $getTransactionStmt->execute([$transaction_id, $ticket_id, 'ticket_refund', $tenant_id, $branch_id, $tenant_id, $branch_id]);
    ...
    ");
    $deleteResult = $deleteStmt->execute([$transaction_id, $ticket_id, 'ticket_refund', $tenant_id, $branch_id]);

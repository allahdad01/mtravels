...
<div class="container">
    ...
    <div class="letter-body">
        <p>درنو د شرکت / ادارې د منابع بشري مسئولینو ته: <span class="field-line"><?php echo htmlspecialchars($settings['agency_name']); ?> - <?php echo htmlspecialchars($branch['name']); ?></span></p>

...
<div class="container">
    ...
    <h1>د <?php echo $settings['agency_name']; ?> - <?php echo htmlspecialchars($branch['name']); ?> شرکت<br>توسعه‌خط</h1>
...
<div class="agreement-body">
    ...
    <div class="clause">
        <h3>د دندې د سرغړونې له امله رسمي تذکر</h3>
        <p>
            درناوی سره، تاسو ته خبر درکول کېږي چې د مدیریت له خوا د ترسره شوو څېړنو له مخې، تاسې لاندې سرغړونه کړې ده:<br><br>
            <?php echo $takhaluf; ?><br><br>

            د اداري نظم او د دندې چوکاټ د خوندي ساتلو د اهمیت له مخې، دغه تذکر تاسو ته د لومړي رسمي اخطار په توګه درکول کېږي. که چیرې دا ډول سرغړونې بیا تکرار شي، اداره به اړ شي چې جدي انضباطي اقدامات ترسره کړي، چې کېدای شي پکې د دندې ځنډول، د معاش کمول، یا د قرارداد فسخ شامل وي.

            هیله ده چې له دې وروسته به له ورته سرغړونو څخه ډډه وکړئ او خپلې دندې به په مسؤلانه ډول او د اداري اصولو سره سم ترسره کړئ.
        </p>
    </div>
</div>

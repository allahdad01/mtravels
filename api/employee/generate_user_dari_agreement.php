...
<div class="container">
    ...
    <div class="header">
        ...
        <h1><?php echo htmlspecialchars($settings['agency_name']); ?> - <?php echo htmlspecialchars($branch['name']); ?><br>قرارداد استخدام</h1>
...
<div class="agreement-body">
    <div class="personal-info">
        ...
        <p><?php echo htmlspecialchars($settings['agency_name']); ?> - <?php echo htmlspecialchars($branch['name']); ?> (که از این پس "شرکت" یاد می‌شود)</p>
        <p>و</p>
        ...
        <p>بدین‌وسیله موافقت می‌نمایم که تحت شرایط ذیل با <?php echo htmlspecialchars($settings['agency_name']); ?> - <?php echo htmlspecialchars($branch['name']); ?> کار نمایم:</p>
    </div>

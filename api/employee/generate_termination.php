...
<div class="container">
    <div class="controls no-print">
        <button onclick="window.print();" class="btn">چاپ نامه ختم قرارداد</button>
        <button onclick="window.history.back();" class="btn">برگشت</button>
    </div>

    <div class="header">
    <img src="<?php echo htmlspecialchars($logoPath); ?>" alt="لوگو">
    <h1>شرکت <?php echo $settings['agency_name']; ?> - <?php echo htmlspecialchars($branch['name']); ?><br> ختم قرارداد</h1>
...
<div class="agreement-body">
    ...
    <div class="clause">
        <h3>موضوع: ختم قرارداد کاری</h3>
        <p>
            محترمانه به اطلاع شما رسانیده می‌شود که بر اساس تخلفات وظیفوی متعدد و عدم رعایت مقررات اداره، علی‌رغم صدور توصیه خط و اخطار خط، هیچ‌گونه بهبود در عملکرد شما مشاهده نگردید.<br><br>

            بنابراین، مطابق به مقررات انضباطی و ماده‌های مندرج در قرارداد کاری شما با شرکت/اداره، تصمیم بر آن گرفته شده است که **قرارداد کاری شما به تاریخ <?php echo $termination_date; ?> رسماً خاتمه یابد**.<br><br>

            لطفاً در مدت باقیمانده وظیفه، وسایل و اسناد اداره را تحویل داده و مراحل تسلیمی خویش را تکمیل نمایید. در صورت داشتن هرگونه حق‌الزحمه باقی‌مانده یا اسناد رسمی، پس از طی مراحل تسویه حساب، در اختیار شما قرار خواهد گرفت.

            از همکاری‌های گذشته شما سپاس‌گزاری می‌گردد و برایتان در آینده آرزوی موفقیت داریم.
        </p>
    </div>

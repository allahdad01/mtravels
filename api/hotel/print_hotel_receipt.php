...
// Fetch transaction details with hotel booking information
$query = "
    SELECT
        mat.*,
        hb.id as booking_id,
    ...
    LEFT JOIN hotel_bookings hb ON mat.reference_id = hb.id AND mat.transaction_of = 'hotel'
    LEFT JOIN clients uc ON hb.sold_to = uc.id
    LEFT JOIN suppliers us ON hb.supplier_id = us.id
...
<div class="receipt">
    ...
    <section class="description">
        ...
        <div class="ticket-info">
            <div class="label"><?php echo __('hotel_information'); ?></div>
            <div class="ticket-grid">
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('guest_name'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['guest_name']); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('order_id'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['order_id']); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('contact'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['contact_no']); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('check_in_date'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['check_in_date']); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('check_out_date'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['check_out_date']); ?></div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('accommodation_details'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['accommodation_details']); ?></div>
                </div>
            </div>
        </div>
        <?php endif; ?>

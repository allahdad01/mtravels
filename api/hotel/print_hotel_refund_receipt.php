...
// Fetch transaction details with hotel refund information
$query = "
    SELECT
        mat.*,
        hr.refund_type,
        hr.reason,
        hr.refund_amount as refund_amount,
        hr.currency as refund_currency,
        hr.exchange_rate,
        hb.id as booking_id,
    ...
    LEFT JOIN hotel_refunds hr ON mat.reference_id = hr.id AND mat.transaction_of = 'hotel_refund'
    ...
    WHERE mat.id = ? AND mat.transaction_of = 'hotel_refund' AND mat.tenant_id = ? AND mat.branch_id = ?
";

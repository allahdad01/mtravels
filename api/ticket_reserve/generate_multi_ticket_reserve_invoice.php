...
// --- 4. Fetch paid amounts for ticket reservations ---
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br><small>Return: <?php echo htmlspecialchars($ticket['return_destination']); ?></small>
                        <?php endif; ?>
                        <br><small>Date: <?php echo date('M j, Y', strtotime($ticket['departure_date'])); ?></small>
                        <?php if ($ticket['trip_type'] === 'round_trip' && $ticket['return_date']): ?>
                        <br><small>Return Date: <?php echo date('M j, Y', strtotime($ticket['return_date'])); ?></small>
                        <?php endif; ?>
                    </td>

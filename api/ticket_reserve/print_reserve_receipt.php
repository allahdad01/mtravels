...
$query = "
    SELECT
        ...
        tr.trip_type,
        tr.return_date,
        tr.return_destination,
        c.name as client_name,
        s.name as supplier_name
    FROM main_account_transactions mat
    LEFT JOIN ticket_reservations tr ON mat.reference_id = tr.id AND mat.transaction_of = 'ticket_reserve'
    LEFT JOIN clients c ON tr.sold_to = c.id
    LEFT JOIN suppliers s ON tr.supplier = s.id
...
<div class="receipt">
    ...
    <section class="description">
        ...
        <div class="ticket-info">
            <div class="label"><?php echo __('ticket_information'); ?></div>
            <div class="ticket-grid">
                ...
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('pnr'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['pnr']); ?></div>
                </div>
                <div class="ticket-item">
                    ...
                    <div class="ticket-value">
                        ...
                        <?php if ($transaction['trip_type'] === 'round_trip' && !empty($transaction['return_destination'])): ?>
                            - <?php echo htmlspecialchars($transaction['return_destination']); ?>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('airline'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['airline']); ?></div>
                </div>
                <div class="ticket-item">
                ...
                <?php if ($transaction['trip_type'] === 'round_trip' && !empty($transaction['return_date'])): ?>
                <div class="ticket-item">

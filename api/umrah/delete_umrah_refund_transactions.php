...
try {
    ...
    ");
    $getTransactionStmt->execute([$transaction_id, $refund_id, 'umrah_refund', $tenant_id, $branch_id, $tenant_id, $branch_id]);
    ...
    $deleteStmt = $pdo->prepare("
        ...
        AND tenant_id = ? AND branch_id = ?
    ");
    $deleteResult = $deleteStmt->execute([$transaction_id, $refund_id, 'umrah_refund', $tenant_id, $branch_id]);

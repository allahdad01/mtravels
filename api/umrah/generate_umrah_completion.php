...
$lang_file = '../../includes/languages/' . $lang . '/umrah_service_completion.php';

if (file_exists($lang_file)) {
    $l = require($lang_file);
} else {
    // Fallback to English
    $l = require('../../includes/languages/en/umrah_service_completion.php');
}
...
try {
    ...
    $query = "
        ...
        LEFT JOIN suppliers s ON s.id = COALESCE(uff.supplier_id, ubs.supplier_id) AND s.tenant_id = ? AND s.branch_id = ?

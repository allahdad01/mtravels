...
// Fetch transaction details with umrah booking information
$query = "
    SELECT
        ut.id,
        ut.transaction_type,
        ...
        f.package_type
    FROM umrah_transactions ut
    LEFT JOIN umrah_bookings ub ON ut.umrah_booking_id = ub.booking_id
    LEFT JOIN clients uc ON ub.sold_to = uc.id
    LEFT JOIN families f ON ub.family_id = f.family_id
    WHERE ut.id = ? AND ut.tenant_id = ? AND ut.branch_id = ?
";
...
<title><?php echo __('receipt'); ?> - <?php echo htmlspecialchars($transaction['payment_description']); ?></title>
<style>
...
<div class="receipt">
    ...
    <section class="meta">
        ...
        <div>
            ...
            <div class="value"><?php echo date('M d, Y', strtotime($transaction['payment_date'])); ?></div>
        </div>

        <div>
            <div class="label"><?php echo __('time'); ?></div>
            <div class="value"><?php echo date('h:i A', strtotime($transaction['payment_date'])); ?></div>
        </div>

        <div>
            <div class="label"><?php echo __('transaction_to'); ?></div>
            <div class="value"><?php echo htmlspecialchars($transaction['transaction_to']); ?></div>
        </div>
    </section>
    ...
    <section class="main-row">
        ...
        <div class="amount-box">
            ...
            <div class="amount">
                <?php echo number_format($transaction['payment_amount'], 0); ?> <?php echo htmlspecialchars($transaction['currency']); ?>
            </div>
        </div>
    </section>
    ...
    <section class="description">
        ...
        <div class="description-text">
            <?php echo htmlspecialchars($transaction['payment_description']); ?>
        </div>

        <?php if (!empty($transaction['booking_id'])): ?>
        <div class="ticket-info">
            <div class="label"><?php echo __('umrah_information'); ?></div>
            <div class="ticket-grid">
                ...
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('package_type'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['package_type']); ?></div>
                </div>
                <?php if (!empty($transaction['departure_date'])): ?>
                <div class="ticket-item">
                ...
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('return_date'); ?></div>
                    <div class="ticket-value"><?php echo htmlspecialchars($transaction['return_date']); ?></div>
                </div>
                <?php endif; ?>
                <div class="ticket-item">
                    <div class="ticket-label"><?php echo __('client'); ?></div>

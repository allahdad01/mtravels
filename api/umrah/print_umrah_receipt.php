        ...
        <div class="receipt-container">
            ...
            <div class="receipt-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value description-value"><?php echo htmlspecialchars($transaction['payment_description']); ?></span>
                </div>

                <div class="detail-row">
                    <span class="detail-label"><?php echo __('transaction_to'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['transaction_to']); ?></span>
                </div>
            ...
            <div class="amount-section">
                ...
                <div class="amount-value">
                    <?php echo htmlspecialchars($transaction['currency']); ?> <?php echo number_format($transaction['payment_amount'], 2); ?>
                </div>

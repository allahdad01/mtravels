                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">User Addon Payments</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="manage_user_addons.php">User Addons</a></li>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#recordPaymentModal">
                                    <i class="feather icon-plus-circle mr-2"></i>Record User Addon Payment
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card shadow-lg border-0">
                                    <div class="card-header">
                                        <h4 class="mb-0"><i class="feather icon-credit-card mr-2"></i>Active User Addons with Payment History</h4>
                                    </div>
                                    <div class="card-body p-0">
                                        <?php if (empty($active_addons)): ?>
                                        <div class="text-center py-4">
                                            <i class="feather icon-inbox text-muted mb-2" style="font-size: 2rem;"></i>
                                            <p class="text-muted">No active user addons found</p>
                                        </div>
                                        <?php else: ?>
                                        ...
                                        <div class="addon-section border-bottom">
                                            <div class="p-3 bg-light d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <span class="badge badge-success ml-2">+<?= intval($addon['additional_users']) ?> users</span>
                                                    <span class="text-muted ml-2">| <?= number_format($addon['total_addon_cost'], 2) . ' ' . $symbol ?>/month</span>
                                                </div>
                                                <div>
                                                    <span class="text-muted">Total Paid: <?= number_format($total_paid, 2) . ' ' . $symbol ?></span>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-sm table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= number_format($payment['amount'], 2) . ' ' . $symbol ?></td>

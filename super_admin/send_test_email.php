...
try {
    ...
    $mail->setFrom(
        ...
        !empty($smtpFromName) ? $smtpFromName : 'MTravels Platform'
    );
    $mail->addAddress($testEmail);

    // Content
    $mail->isHTML(true);
    $mail->Subject = 'SMTP Test Email - MTravels Platform';
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <p>If you received this email, your SMTP settings are properly configured and ready to send emails from your platform.</p>

                <hr>
                <p style='font-size: 12px; color: #666;'>
                    This is an automated test email from MTravels Platform.<br>
    ...
    $mail->AltBody = "SMTP Test Email - MTravels Platform
...
If you received this email, your SMTP settings are properly configured and ready to send emails from your platform.

---
This is an automated test email from MTravels Platform.
If you did not expect this email, please contact your system administrator.";

                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Manage Tenant Branch Addon Pricing</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Settings</a></li>
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Branch Addon Pricing</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Branch Addon Pricing by Tenant <span class="badge badge-info"><?= $total_items ?> total</span></h5>
                                        <span class="text-muted">Manage the pricing for additional branch add-ons per tenant</span>
                                    </div>
                                    <div class="card-body table-border-style">
                                        <!-- Search Form -->
                                        <div class="mb-3">
                                            <form method="GET" action="manage_tenant_addon_pricing.php" class="form-inline">
                                                ...
                                                <a href="manage_tenant_addon_pricing.php" class="btn btn-secondary">Clear</a>
                                                <?php endif; ?>
                                            </form>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                             <span class="price-display" data-tenant-id="<?= $tenant['id'] ?>">
                                                                 ...
                                                                 echo $tenant['monthly_price'] ? $symbol . number_format($tenant['monthly_price'], 2) : 'Not set';
                                                                 ?>
                                                             </span>
                                                         </td>
                                                         <td>
                                                             <span class="price-display" data-tenant-id="<?= $tenant['id'] ?>">
                                                                 <?php 
                                                                 $symbol = getCurrencySymbol($tenant['currency'] ?? 'USD');
                                                                 echo $tenant['quarterly_price'] ? $symbol . number_format($tenant['quarterly_price'], 2) : 'Not set';
                                                                 ?>
                                                             </span>
                                                         </td>
                                                         <td>
                                                             <span class="price-display" data-tenant-id="<?= $tenant['id'] ?>">
                                                                 <?php 
                                                                 $symbol = getCurrencySymbol($tenant['currency'] ?? 'USD');
                                                                 echo $tenant['yearly_price'] ? $symbol . number_format($tenant['yearly_price'], 2) : 'Not set';
                                                                 ?>
                                                             </span>
                                                         </td>
                                                        <td><?= htmlspecialchars($tenant['currency'] ?? 'USD') ?></td>
                                                        <td>

$(document).ready(function () {
    ...
    window.openRefundModal = function (visaId, soldPrice, basePrice, currency) {
        $('#refundVisaId').val(visaId);
    ...
    $('#refundVisaForm').submit(function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: '../api/visa/process_visa_refund.php',
            method: 'POST',
            data: formData,

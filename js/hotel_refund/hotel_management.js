...
function editHotelRefund(id) {
    ...
    fetch('../api/hotel/get_hotel_refund_details.php?id=' + id)
        .then(response => response.json())
        .then(data => {
                ...
                '<div class="refund-edit-form">' +
                    '<div class="refund-info-card">' +
                        '<div class="refund-info-row">' +
                            ...
                            '<span class="refund-info-value">' + escapeHtml(r.title) + ' ' + escapeHtml(r.first_name) + ' ' + escapeHtml(r.last_name) + '</span>' +
                        '</div>' +
                        '<div class="refund-info-row">' +
                            '<span class="refund-info-label">Hotel</span>' +
                            '<span class="refund-info-value">' + escapeHtml(r.accommodation_details || '') + '</span>' +
                        '</div>' +
                    '</div>' +
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch('../api/hotel/update_hotel_refund.php', {
                        method: 'POST',

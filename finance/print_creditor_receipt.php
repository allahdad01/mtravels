...
$query = "
    ...
    WHERE mat.reference_id = ? AND mat.transaction_of = 'creditor'
";
        ...
        <div class="receipt-container">
            ...
            <div class="receipt-header">
                <div class="header-row">
                    ...
                    <div class="receipt-title">Creditor Payment Receipt</div>
            ...
            <div class="receipt-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo $transaction['type'] === 'debit' ? __('payment_made') : __('received'); ?></span>
                </div>
                ...
                <div class="detail-row">
                    <span class="detail-label"><?php echo __('creditor_name'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['creditor_name']); ?></span>
                </div>

                <?php if (!empty($transaction['creditor_email'])): ?>
                <div class="detail-row">
                    <span class="detail-label"><?php echo __('email'); ?>:</span>
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['creditor_email']); ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo htmlspecialchars($transaction['creditor_phone']); ?></span>
                </div>
                <?php endif; ?>

                <?php if (!empty($transaction['client_name'])): ?>
                <div class="detail-row">
                    <span class="detail-label"><?php echo __('linked_client'); ?>:</span>
            ...
            <div class="amount-section">
                ...
                <div class="signature-section">
                    <div class="signature-box">
                        <div class="signature-label">Creditor Sign</div>

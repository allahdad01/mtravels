...
<div class="container">
    ...
    <div>
        <strong>د بانک نوم:</strong> <?= htmlspecialchars($bank_name) ?><br>
        <strong>د بانکي حساب شمېره:</strong> <?= htmlspecialchars($bank_account_number) ?><br>
        <strong>د حساب نوم:</strong> <?= htmlspecialchars($account_name) ?><br>
    </div>

    <div class="section-title">د کورنۍ د غړو لېست</div>
    <table>
        <thead>
            <tr>
                <th>شمېره</th>

    ...
    <div class="container">
        ...
        <div class="creditor-info">
            <div class="info-group">
                <div class="info-label">Creditor Name:</div>
                <div class="info-value"><?= htmlspecialchars($creditor['name']) ?></div>
            </div>
            
            <div class="info-group">
                <div class="info-label">Email:</div>
                <div class="info-value" style="word-break: break-all; max-width: 200px;"><?= htmlspecialchars($creditor['email'] ?: 'N/A') ?></div>
            </div>
            
            <div class="info-group">
                <div class="info-label">Phone:</div>
                <div class="info-value"><?= htmlspecialchars($creditor['phone'] ?: 'N/A') ?></div>
            </div>
            
            <div class="info-group">
                <div class="info-label">Address:</div>
                <div class="info-value"><?= htmlspecialchars($creditor['address'] ?: 'N/A') ?></div>
            </div>
        </div>
        ...
        <div class="summary-box">
            <div class="summary-item">
                ...
                <div class="summary-value"><?= $currency_symbol ?> <?= number_format($creditor['balance'] + $total_paid, 2) ?></div>
            </div>
            ...
            <div class="summary-item">
                ...
                <div class="summary-value balance"><?= $currency_symbol ?> <?= number_format($creditor['balance'], 2) ?></div>
            </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php else: ?>
                            <span style="color: #e74c3c;">Credit</span>
                        <?php endif; ?>
                    </td>
                    <td class="text-right">

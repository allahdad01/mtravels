...
<body>
    <div class="container">
        <div class="header">
            ...
            <table width="100%">
                <tr>
                    ...
                    تاریخ: <?= date('Y/m/d') ?><br>
                    مرجع : FAM-CANC-<?= $family['family_id'] ?>
                    </td>
                </tr>
            </table>
        </div>

        <div class="section-header">اطلاعات خانوادگی</div>
        <table class="details-table">
            <tr>
                <td>شناسه خانوادگی</td>
                <td>FAMILY-<?= htmlspecialchars($family['family_id']) ?></td>
            </tr>
            <tr>
                <td>سرپرست خانواده</td>
        ...
        <div class="section-header">اطلاعات عضوها</div>
        ...
        if (!empty($cancellationDetails['additional_notes'])): ?>
            <div class="section-header">سبب لغو عمره</div>
        ...
        <div class="terms-box">
            <div class="section-header">اعلان لغو عمره</div>
            <p class="terms-text">این سند تأیید می‌کند که خدمات عمرۀ خانوادۀ ذکر شده در بالا لغو گردیده است. تمامی اسناد اصلی به نمایندۀ خانواده مسترد گردیده است. خانواده شرایط و فیس لغو را مطابق قرارداد پذیرفته است. هر نوع استرداد مطابق پالیسی بازپرداخت اداره پروسس می‌گردد.</p>
        </div>

            ...
            <div class="modal-body">
                <form id="familyCompletionDetailsForm">
                    ...
                    <div class="alert alert-info">
                         <?= __('please_select_the_family_members_whose_service_is_complete') ?>
                     </div>

                     <div id="familyCompletionMembersContainer" class="mb-3">
                         <!-- Members will be generated by JavaScript -->
                     </div>

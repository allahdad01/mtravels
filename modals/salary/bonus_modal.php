<!-- Salary Bonus Modal (standalone, embedded by Payments Journal) -->
<div class="modal fade" id="salaryBonusModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="feather icon-award mr-2"></i><?= __('record_bonus') ?></h5>
                <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
            </div>
            <form id="salaryBonusForm">
                <input type="hidden" name="payment_type" value="bonus">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="feather icon-check mr-1"></i><?= __('pay_bonus') ?>
                    </button>
                </div>
            </form>
        </div>

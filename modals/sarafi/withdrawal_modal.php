<!-- Sarafi Withdrawal Modal (standalone, embedded by Payments Journal) -->
<div class="modal fade" id="sarafiWithdrawModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form id="sarafiWithdrawForm" enctype="multipart/form-data">
